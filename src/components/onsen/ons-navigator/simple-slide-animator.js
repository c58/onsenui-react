...
export default class SimpleSlideNavigatorTransitionAnimator extends NavigatorTransitionAnimator {
  ...
  push(enterPage, leavePage, callback) {
    ...
    leavePageElem.parentElement.insertBefore(this.backgroundMask, enterPageElem.nextSibling);
  ...
  pop(enterPage, leavePage, done) {
    ...
    const leavePageElem = ReactDOM.findDOMNode(leavePage);
    const enterPageElem = ReactDOM.findDOMNode(enterPage);
    enterPageElem.parentNode.insertBefore(this.backgroundMask, leavePageElem.nextSibling);
